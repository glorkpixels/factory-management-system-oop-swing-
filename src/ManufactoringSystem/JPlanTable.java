...
public class JPlanTable extends JFrame {
	...
	public JPlanTable()
	{
        ...
        JLabel label = new JLabel("Plan ID: ");
        ...
        JLabel label_2 = new JLabel("Plan Type:");
        ...
        btnAdd.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                planList.add(new Plan(txtName.getText(),Integer.parseInt(cBoxSeatId.getSelectedItem().toString()), txtType.getText()));
