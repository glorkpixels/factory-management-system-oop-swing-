	...
	public JWorkerEnter() {
		...
		btnLogIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(txtID.getText().equals("3000") && passwordField.getText().equals("worker1234"))
				{
					new JWorkerMenu().setVisible(true);
