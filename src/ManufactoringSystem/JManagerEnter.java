	...
	public JManagerEnter() {
		...
		btnLogIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(txtID.getText().equals("1000") && passwordField.getText().equals("manager1234"))
				{
					new JManagerMenu().setVisible(true);
