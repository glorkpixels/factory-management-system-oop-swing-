...
public class JStorageTable extends JFrame {
	...
	public JStorageTable()
	{
        ...
        JLabel label = new JLabel("Storage ID: ");
        ...
        JLabel label_2 = new JLabel("Storage Type:");
        ...
        btnAdd.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                storageList.add(new Storage(txtName.getText(), txtType.getText(),Integer.parseInt(cBoxSeatId.getSelectedItem().toString())));
