...
public class JProductTable extends JFrame {
	...
	public JProductTable()
	{
        ...
        JLabel label_2 = new JLabel("Product Type:");
        ...
        btnAdd.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                productList.add(new Product(txtName.getText(),Integer.parseInt(cBoxSeatId.getSelectedItem().toString()),txtType.getText()));
