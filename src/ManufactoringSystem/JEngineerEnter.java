...
public class JEngineerEnter {
	 ...
	 */
	public JEngineerEnter() {
		frame = new JFrame();
		frame.setBounds(100, 100, 369, 271);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		lblID = new JLabel("Engineer ID:");
		...
		btnLogIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(txtID.getText().equals("2000") && passwordField.getText().equals("engineer1234"))
				{
					new JEngineerMenu().setVisible(true);
